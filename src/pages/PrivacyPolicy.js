...
const PrivacyPolicy = () => {
  return (
    <Box pb="6vh" w="100%" className="PrivacyPolicyPage">
      <RichText secondHeadingText=" Privacy Policy" secondHeadingSize="3vh" />

      <Flex className="privacyPolicyDiv" pt="6vh" w="100%" flexDirection="row">
        <Box className="privacyPolicyDiv" w="50%" px="2rem">
          <Text>
            {`Last updated 29/10/2021

INTRODUCTION

Earthfriend Candles (“we” or “us” or “our”) respects the privacy of our users (“user” or “you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website [name of website.com] [and our mobile application], including any other media form, media channel, mobile website, or mobile application related or connected thereto (collectively, the “Site”). Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
...
[Email]
    `}
        ...
        >
          <Image
            alt="image of colourful candles"
            className="privacyPolicyImg"
            src="https://res.cloudinary.com/dwtu8mm8m/image/upload/v1635276704/earthfriendcandles/privacy_policy_aqj1l4.jpg"
          />
        </Box>
      </Flex>
